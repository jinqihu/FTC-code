...
@Autonomous(name = "LM2RedFarSideAutoWithPush", group = "LM2")
public class pushauto extends OpMode {
    ...
    /* Poses */
    private final Pose pushPose = new Pose(50, 8, Math.toRadians(0));
    private final Pose startPose = new Pose(88, 10, Math.toRadians(180));
    private final Pose scorePose = new Pose(88, 95, Math.toRadians(45));
    private final Pose pickup1Pose = new Pose(95, 89, Math.toRadians(0));
    private final Pose pickup1closePose = new Pose(130, 89, Math.toRadians(0));
    private final Pose pickup2Pose = new Pose(95, 69, Math.toRadians(0));
    private final Pose pickup2closePose = new Pose(134, 68, Math.toRadians(0));
    private final Pose pickup3Pose = new Pose(95, 45, Math.toRadians(0));
    private final Pose pickup3closePose = new Pose(132, 45, Math.toRadians(0));
    private final Pose end = new Pose(130, 140, Math.toRadians(180));

    private PathChain scorepreload, grabPickup1, grabPickup2, grabPickup3;
    private PathChain scorePickup1, scorePickup2, scorePickup3, pushPartner, pushPartnerBack;
    private PathChain grabclosePickup1, grabclosePickup2, grabclosePickup3 , asdf;

    public void buildPaths() {
        pushPartner = follower.pathBuilder()
                .addPath(new BezierLine(startPose, pushPose))
                .setLinearHeadingInterpolation(startPose.getHeading(), pushPose.getHeading())
                .build();

        scorepreload = follower.pathBuilder()
                .addPath(new BezierLine(pushPose, scorePose))
        ...
        scorePickup2 = follower.pathBuilder()
                .addPath(new BezierLine(pickup2closePose, scorePose))
        ...
        scorePickup3 = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(pickup3closePose.getHeading(), scorePose.getHeading())
                .build();
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 2:
                if (!follower.isBusy()) {
                    follower.followPath(grabclosePickup1, 0.6, false);
                    setPathState(3);
                }
                break;
            ...
            case 4:
                ...
                if (!follower.isBusy()) {
                    follower.followPath(grabPickup2, 1, false);
                    waitMs(4000);
                    setPathState(5);
                }
                break;
            ...
            case 5:
                ...
                if (!follower.isBusy()) {
                    follower.followPath(grabclosePickup2, 0.6, false);
                    setPathState(6);
                }
                break;
            ...
            case 6:
                if (!follower.isBusy()) {
                    follower.followPath(scorePickup2, 1, false);
                    setPathState(7);
                }
                break;
            ...
            case 7:
                ...
                if (!follower.isBusy()) {
                    follower.followPath(grabPickup3, 1, false);
                    waitMs(4000);
                    setPathState(8);
                }
                break;
            ...
            case 8:
                ...
                if (!follower.isBusy()) {
                    follower.followPath(grabclosePickup3, 1, false);
                    setPathState(9);
                }
                break;
            ...
            //case 9:
            //if (!follower.isBusy()) {
            //follower.followPath(scorePickup3, 1, false);
            //setPathState(10);
            //}
            //break;
            //case 10:
