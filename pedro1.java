...
@Autonomous(name = "LM2BlueFarSideAutoWithPush", group = "Pedropathing")
public class pedro1 extends OpMode {
    ...
    private final Pose end = new Pose(48, 48, Math.toRadians(180));
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            case 0:
                if (!follower.isBusy()) {
                    follower.followPath(pushPartner, 1, false);
                    setPathState(1);
                }
                break;
            case 1:
            ...
            case 3:
                if (!follower.isBusy()) {
                    follower.followPath(grabclosePickup1, 1, false);
                    setPathState(4);
                }
                break;
            ...
            case 6:
                ...
                if (!follower.isBusy()) {
                    follower.followPath(grabclosePickup2, 1, false);
                    setPathState(7);
                }
                break;
